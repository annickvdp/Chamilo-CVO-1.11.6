...
$schedule_profile = 'aula'; // standard(weekdays, sat morning), aula(evenings, sat morning)
 
 

// set current item test values
$build_periods_for_item_or_category = 'category'; // 'item' or 'category'
$category_id=8; //Materiaal fotografie
