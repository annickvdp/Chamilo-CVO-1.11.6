...
$item_id = 64;  // unique item id - dokeos_reservation.item.id // 64 is the studio
...
$courses_that_need_permissions[0]['course_title'] = 'FotoCurMat';  
$courses_that_need_permissions[0]['course_code'] = 'FOTOCURMAT'; //Administrators of the photography materials
$courses_that_need_permissions[0]['class_id'] = '3697';
$courses_that_need_permissions[0]['admin'] = true;

$courses_that_need_permissions[1]['course_title'] = 'DocentenFotografie';  
$courses_that_need_permissions[1]['course_code'] = 'd23'; //TEACHERS OF PHOTOGRAPHY / / course codes - class-code 454
$courses_that_need_permissions[1]['class_id'] = '454';

$courses_that_need_permissions[2]['course_title'] = '11SPortretVrAvErwinL';  
$courses_that_need_permissions[2]['course_code'] = '2146416123'; // this should be the main key veriable
$courses_that_need_permissions[2]['class_id'] = '3240';
...
$start_date_string = "Sept 1, 2011";
$end_date_string = "June 30, 2012";
...
foreach ($item_array as $current_item_id){
		...
		if($set_item_rights){
			...
			*/
			...
			foreach ($courses_that_need_permissions as $c){
			 ...
			 // @todo -- needs to be dynamic for more than one course
				$sql = "INSERT INTO dokeos_reservation.item_rights (item_id, class_id, edit_right, delete_right, m_reservation, view_right) VALUES (".$current_item_id.", '".$c['class_id']."', ".$edit_right.", ".$delete_right.", ".$m_reservation.", ".$view_right.") ;";
				
				$result=mysql_query($sql) or (print '<br/>SETTING ITEM RIGHTS FAILED '.$sql.' '.mysql_error().'<bR/>'); 
