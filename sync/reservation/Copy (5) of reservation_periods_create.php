...
$category_id=7; //Materiaal fotografie - 7 // Lokalen - 8
...
foreach ($item_array as $current_item_id){
		...
		if($set_item_rights){
			...
			while($result_row = mysql_fetch_array($result)){
				$sql = "INSERT INTO dokeos_reservation.item_rights (item_id, class_id, edit_right, delete_right, m_reservation, view_right) VALUES (".$current_item_id.", '".$result_row['class_id']."', ".$edit_right.", ".$delete_right.", ".$m_reservation.", ".$view_right.") ;";
